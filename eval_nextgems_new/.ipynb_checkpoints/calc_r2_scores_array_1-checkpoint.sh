...
#SBATCH --error=/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/eval_nextgems_new/logs/error_r2_scores_%a.log
#SBATCH --output=/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/eval_nextgems_new/logs/output_r2_scores_%a.log
...
srun --ntasks=1 python -u scores.py --model $MODEL_ID --past 1 --score both
