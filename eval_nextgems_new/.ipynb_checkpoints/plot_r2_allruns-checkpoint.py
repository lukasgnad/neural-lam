...
for idx, model in enumerate(future_models):
    model["r2"] = pd.read_csv(
        f"/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/eval_nextgems_new/values/r2_all_variables_{model['id']}.csv",
        index_col=0,
    )
...
#         )
#         axes[0].set_title(f"{display_name} - R² - Test Period: 2016-2019")
#         axes[0].set_xlabel("Forecasting Time [Hours]")
#         axes[0].set_xlim(6, 6 * 40)
...
#             label=model["model_name"] + f"",
#         )
#         axes[1].set_title(f"{display_name} - R² - Test Period: 2046-2049")
#         axes[1].set_xlabel("Forecasting Time [Hours]")
#         axes[1].set_xlim(6, 6 * 40)
...
#         )
#         axes[0].set_title(
#             f"{display_name} - R² Daily Average - Test Period: 2016-2019"
#         )
...
#         )
#         axes[1].set_title(
#             f"{display_name} - R² Daily Average - Test Period: 2046-2049"
#         )
