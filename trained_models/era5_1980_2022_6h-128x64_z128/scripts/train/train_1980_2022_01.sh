...
#SBATCH --error=/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/trained_models/era5_1980_2022_6h-128x64_equiangular_with_poles_conservative/logs/error_train_era5_1980_2022_6h-128x64_01.log
#SBATCH --output=/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/trained_models/era5_1980_2022_6h-128x64_equiangular_with_poles_conservative/logs/output_train_era5_1980_2022_6h-128x64_01.log
...
# --- Variables
run_name=1980_2022_6h_128_64
dataset_name=global_era5_1980_2022_6h-128x64_equiangular_with_poles_conservative
dataset_path=$(ws_find neural_lam)/data/data
graph_name=global_multilevel_128x64
