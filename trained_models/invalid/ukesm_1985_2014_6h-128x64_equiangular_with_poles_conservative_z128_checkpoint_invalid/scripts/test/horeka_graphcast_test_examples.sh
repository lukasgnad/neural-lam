...
# Copy these step by step to command line
...
# Eval checkpoint 3 no forecasts
python train_model.py\
    --name ${name_full}_test_03_no_forecasts\
    --dataset global_${name}\
    --dataset_path $(ws_find neural_lam)/data/data\
    --model graphcast\
    --n_workers 4\
    ...
    --periods "train:1990-01-01,2015-12-31;val:2016-01-01,2017-12-31;test:2018-01-01,2019-12-31"\
    --wandb_output trained_models/${name_full}/test_runs/wandb_test_03_no_forecasts\
    --eval test
...
python train_model.py\
    --name ${name_full}_test_03_forecasts\
    --dataset global_${name}\
    --dataset_path $(ws_find neural_lam)/data/data\
    --model graphcast\
    --n_workers 4\
    ...
    --load trained_models/${name_full}/checkpoints/checkpoint_03/last.ckpt\
    --periods "train:1990-01-01,2015-12-31;val:2016-01-01,2017-12-31;test:2018-01-01,2019-12-31"\
    --wandb_output trained_models/${name_full}/test_runs/wandb_test_03_forecasts\
    --save_forecasts 1\
...
# Eval checkpoint 3 no forecasts, on 2049
python train_model.py\
...
python train_model.py\
    --name ${name_full}_test_03_2049_forecasts\
    --dataset global_nextgems_2049_equiangular_with_poles_conservative\
    --dataset_path $(ws_find neural_lam)/data/data\
    --model graphcast\
    --n_workers 4\
    ...
    --load trained_models/${name_full}/checkpoints/checkpoint_03/last.ckpt\
    --periods "train:2049-01-01,2049-12-31;val:2049-01-01,2049-12-31;test:2049-01-01,2049-12-31"\
    --wandb_output trained_models/${name_full}/test_runs/wandb_test_03_2049_forecasts\
    --save_forecasts 1\
    --save_levels 500,700,850\
    --eval test
