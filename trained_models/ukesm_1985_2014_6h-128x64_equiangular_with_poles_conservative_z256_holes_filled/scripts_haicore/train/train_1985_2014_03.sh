...
#SBATCH --error=/hkfs/work/workspace_haic/scratch/xo8179-neural_lam_copy/neural-lam/trained_models/ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z256_holes_filled/logs/error_train_03.log
#SBATCH --output=/hkfs/work/workspace_haic/scratch/xo8179-neural_lam_copy/neural-lam/trained_models/ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z256_holes_filled/logs/output_train_03.log
...
# --- Variables
dataset_type=ukesm
run_name=ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z256_holes_filled
