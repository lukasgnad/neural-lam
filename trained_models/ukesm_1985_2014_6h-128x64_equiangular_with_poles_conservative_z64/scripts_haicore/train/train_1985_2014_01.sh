...
#SBATCH --error=/hkfs/work/workspace_haic/scratch/xo8179-neural_lam_copy/neural-lam/trained_models/ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z64/logs/error_train_01.log
#SBATCH --output=/hkfs/work/workspace_haic/scratch/xo8179-neural_lam_copy/neural-lam/trained_models/ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z64/logs/output_train_01.log
...
# --- Variables
dataset_type=ukesm
run_name=ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z64_
