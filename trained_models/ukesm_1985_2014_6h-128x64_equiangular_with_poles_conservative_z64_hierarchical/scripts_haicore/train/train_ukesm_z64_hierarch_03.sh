...
#SBATCH --error=/hkfs/work/workspace_haic/scratch/xo8179-neural_lam_copy/neural-lam/trained_models/ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z64_hierarchical/logs/error_train_03.log
#SBATCH --output=/hkfs/work/workspace_haic/scratch/xo8179-neural_lam_copy/neural-lam/trained_models/ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z64_hierarchical/logs/output_train_03.log
...
# --- Variables
dataset_type=ukesm
run_name=ukesm_1985_2014_6h-128x64_equiangular_with_poles_conservative_z64_hierarchical
dataset_name=global_1985_2014_equiangular_wp_conservative_40_chunks
dataset_path=/hkfs/work/workspace/scratch/xo8179-ukesm/
graph_name=global_hierarchical_ukesm_withpoles_conservative
model_name=graph_fm
tmp_path=$TMPDIR
hidden_dim=64
epochs_first=70
