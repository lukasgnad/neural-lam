...
unroll_second=4
unroll_third=8
periods="train:2019-01-01T12,2019-09-30T12;val:2019-10-01T12,2019-10-31T12;test:2019-11-01T12,2019-12-31T18"
# --- Variables
...
rm -rf saved_models/${run_name}_01
echo "----------------------------------------------"
...
echo ""
rm -rf saved_models/${run_name}_02
echo "----------------------------------------------"
...
echo ""
rm -rf saved_models/${run_name}_03
echo "----------------------------------------------"
