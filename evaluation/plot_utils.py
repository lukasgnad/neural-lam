...
PAST_MODELS_NG_era5 = [
    # Nextgems conservative multilevel (1990-2020, 128x64, z64)
    {
        ...
        "ground_truth": "/hkfs/work/workspace/scratch/xo8179-neural_lam/data/data/copied/global_nextgems_1990_2020_6h-128x64_equiangular_with_poles_conservative_test_only/fields.zarr",
...
FUTURE_MODELS_NG_era5 = [
    # Nextgems conservative multilevel (1990-2020, 128x64, z64)
    {
        ...
        "ground_truth": "/hkfs/work/workspace/scratch/xo8179-neural_lam/data/data/copied/global_nextgems_2046_2049_equiangular_with_poles_conservative/fields.zarr",
        "plot_folder": base_path
...
def plot_single_plot(
    ...
    proj = ccrs.PlateCarree()
    fig, axes = plt.subplots(
        1, 1, figsize=figsize, subplot_kw={"projection": proj}
    )
    ...
    if show:
        ...
        if save_name.endswith(".png") or save_name.endswith(".pdf"):
            plt.savefig(
                base_save_folder + save_name, dpi=300, bbox_inches="tight"
            )
        else:
            plt.savefig(
                base_save_folder + f"{save_name}.png",
                dpi=300,
                bbox_inches="tight",
            )
        plt.close()
