...
#SBATCH --error=/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/eval_ukesm/logs/error_both_final_3_%a.log
#SBATCH --output=/home/hk-project-pai00005/xo8179/neural_lam_fork/neural-lam/eval_ukesm/logs/output_both_final_3_%a.log
...
srun --ntasks=1 python -u scores.py --model 4 --past $MODEL_ID --score both