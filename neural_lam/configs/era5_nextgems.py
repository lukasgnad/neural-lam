...
class ERA5_NextGEMSConfig(BaseConfig):
    ...
    ATMOSPHERIC_PARAMS_SHORT = ["z", "q", "t", "u", "v", "w"]
    ATMOSPHERIC_PARAMS_UNITS = ["m²/s²", "kg/kg", "K", "m/s", "m/s", "Pa/s"]
    ...
    SURFACE_PARAM_UNITS = ["K", "m/s", "m/s", "Pa", "m"]
    ...
    def __init__(self):
        ...
        assert self._get_var_index("z", 500) == 7
        assert self._get_var_index("2t") == 78
        assert self.GRID_STATE_DIM == 83
        ...
        self.VAL_PLOT_VARS = {
            self._get_var_index("z", 500): np.array([2, 20]),  # z500 7
            self._get_var_index("q", 700): np.array([2, 20]),  # q700 22
            self._get_var_index("z", 850): np.array([2, 20]),  # t850 36
            self._get_var_index("2t"): np.array([2, 20]),  # 2t 78
            self._get_var_index("10u"): np.array([2, 20]),  # 10u 79
            self._get_var_index("10v"): np.array([2, 20]),  # 10v 80
            self._get_var_index("tp"): np.array([2, 20]),  # tp 82
        }
